  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-muted/10 p-4">
      <Card className="mx-auto max-w-sm border border-neon/20 shadow-lg bg-background/50">
        ...
        <CardFooter>
          <Button variant="neon" className="w-full" onClick={onLogin}>
            Iniciar Sesión
          </Button>
        </CardFooter>
                ...
                <Card className="border border-neon/20 shadow-lg bg-background/50">
                  ...
                  <CardContent className="space-y-2">
                    <div className="flex items-center gap-4">
                      ...
                      <Button variant="neon" onClick={applyPercentageChange} disabled={isApplyingPercentage}>
                          ...
                          >
                            <div className="flex items-center gap-4">
                              ...
                              <div>
                                ...
                                <p className="text-sm font-bold text-neon">${design.price}</p>
                              </div>
                            </div>
